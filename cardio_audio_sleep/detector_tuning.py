...
def peak_detection_parameters_tuning(
    ...
    height_slider_ax = fig.add_axes([0.1, 0.16, 0.6, 0.03],
    ...
    prominence_slider = Slider(prominence_slider_ax, 'prominence', 0, 2000,
                               valinit=500.)

    # Slider for width
    width_slider_ax = fig.add_axes([0.1, 0.1, 0.6, 0.03],
                                   facecolor='lightgoldenrodyellow')
    ...
    peak_lines = _draw_peaks(axs, data, height_slider.val,
                             prominence_slider.val, width_slider.val, fs)
    ...
    def sliders_on_changed(val):
        ...
        peak_lines = _draw_peaks(axs, data, height_slider.val, prominence,
                                 width, fs)
    ...
    prominence_button = Button(prominence_button_ax, 'Disable',
                               color='lightgoldenrodyellow',
                               hovercolor='0.975')

    # Button to disable width
    width_button_ax = fig.add_axes([0.8, 0.1, 0.1, 0.025])
    width_button = Button(width_button_ax, 'Disable',
                          color='lightgoldenrodyellow',
                          hovercolor='0.975')
